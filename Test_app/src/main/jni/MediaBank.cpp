...
void MediaBank::initAssetPathMaps() {
	...
	image_path_map = std::map<ASSET, ImgDetails>{
		...
		{ ASSET::IMG_TOWER_TREE,			ImgDetails("images/interface/in_game_menu/tower-1.png")					  },
		{ ASSET::IMG_TOWER_TREE_P,			ImgDetails("images/interface/in_game_menu/tower-2.png")					  },
		...
		{ ASSET::IMG_RETURN,				ImgDetails("images/interface/in_game_menu/return-1.png")					  },
		{ ASSET::IMG_RETURN_P,				ImgDetails("images/interface/in_game_menu/return-2.png")					  },
