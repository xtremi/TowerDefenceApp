...
void main()
{
    ...
    vec4 Light_Color1=vec4(0.0, 1.0, 0.0, 0.2);	
    vec4 Light_Color2=vec4(0.0, 1.0, 0.0, 0.2);
    
    
    float Light_Track1  = line(vec2(uv.x,uv.y+(Amplitude1-.5)*.12*Line_Smooth), .11, .0);
   	float Light_Track2  = line(vec2(uv.x,uv.y+(Amplitude2-.5)*.16*Line_Smooth), .08, .0);
